This is the frontend of GlobeVest, a platform that enables users to seamlessly invest in foreign stock indices using a dual-wallet system for local and forex currencies.
